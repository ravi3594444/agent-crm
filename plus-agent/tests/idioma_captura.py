...
_PALABRAS_ES = frozenset(
    ["pedido", "pedidos", "cliente", "clientes", "entrega", "entregas", "codigo", "codigos", "confirmado", "confirmada", "confirmar", "confirma", "pendiente", "pendientes", "revision", "rechazado", "rechazada", "rechazar", "cancelado", "cancelada", "cancelar", "motivo", "motivos", "origen", "informativo", "respondé", "responde", "contesta", "contestá", "para", "que", "con", "sin", "los", "las", "del", "una", "unas", "unos", "por", "como", "cuando", "donde", "esta", "este", "esto", "estan", "estos", "estas", "hace", "falta", "queda", "quedan", "quedo", "dias", "horas", "fecha", "fechas", "monto", "montos", "total", "totales", "stock", "deposito", "precio", "precios", "lista", "listas", "equipo", "dueño", "gerencia", "aviso", "avisos", "alerta", "alertas", "no", "si", "pero", "porque", "tambien", "ahora", "despues", "antes", "tuve", "problema", "tecnico", "disculpa", "disculpas"]
)
