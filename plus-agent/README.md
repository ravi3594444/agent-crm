...
| `tests/` | 1138 tests, none skipped and none xfailed. No ERPNext, no Meta, no LLM, no network — but a real Redis Stack is required. See [Tests and Redis](#tests-and-redis). |
...
make test          # 1138 passed, needs a Redis Stack on REDIS_URL
